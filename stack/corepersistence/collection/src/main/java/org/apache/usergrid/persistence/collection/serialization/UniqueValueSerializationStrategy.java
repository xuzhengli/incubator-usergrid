...
public interface UniqueValueSerializationStrategy extends Migration {
     ...
     */
    MutationBatch write( ApplicationScope applicationScope, CollectionScope collectionScope,  UniqueValue uniqueValue );
     ...
     * @return MutatationBatch that encapsulates operation, caller may or may not execute.
     */
    MutationBatch write( ApplicationScope applicationScope, CollectionScope collectionScope,  UniqueValue uniqueValue, int timeToLive );
    ...
    */
     ...
     * @return
     */
    Iterator<UniqueValue> getAllUniqueFields(ApplicationScope applicationScope, CollectionScope collectionScope, Id entityId);
     ...
     * @return MutatationBatch that encapsulates operation, caller may or may not execute.
     */
    MutationBatch delete(ApplicationScope applicationScope,  CollectionScope scope,  UniqueValue uniqueValue );
