...
public abstract class MvccEntitySerializationStrategyImpl implements MvccEntitySerializationStrategy {
    ...
    public MutationBatch write(final ApplicationScope applicationScope, final CollectionScope collectionScope, final MvccEntity entity ) {
        ...
        return doWrite( applicationScope, collectionScope, entityId, new RowOp() {
            @Override
     ...
     */
    private MutationBatch doWrite(final ApplicationScope applicationScope, final CollectionScope collectionScope, final Id entityId, final RowOp op ) {
