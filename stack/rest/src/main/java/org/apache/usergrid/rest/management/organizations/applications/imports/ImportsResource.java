...
public class ImportsResource extends ServiceResource {
    ...
    @GET
    public ImportResource addIdParameter( @Context UriInfo ui, @PathParam( "entityId" ) PathSegment entityId )
        throws Exception {
        ...
        return getSubResource( ImportResource.class ).init( Identifier.fromUUID( itemId ) );
    }
